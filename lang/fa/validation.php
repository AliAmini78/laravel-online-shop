...
return [
    ...
    */
    ...
    'required_unless' => 'فیلد :attribute الزامی است، مگر آنکه :other بر روی :values تنظیم شده باشد.',
    ...
    */
    ...
    'attributes' => [
        ...
        'province' => 'استان',
        'slug' => 'لینک سئو',
        'sort_order' => 'شماره ترتیب نمایش',
        'status' => 'وضعیت',
        'image' => 'تصویر',
        'thumbnailId' => 'تصویر',
        'avatarId' => 'تصویر',
        'national_id' => 'کد ملی',
        'contact_description' => 'توضیح اطلاعات تماس',
        'contact_address' => 'آدرس اطلاعات تماس',
        'contact_numbers' => 'شماره‌های اطلاعات تماس',
        'contact_email' => 'ایمیل اطلاعات تماس',
        'slogan' => 'شعار سازمانی',
        'about_us' => 'درباره ما',
        'rules' => 'قوانین',
        'body' => 'متن',
        ...
        'business_license_expire_at' => 'تاریخ انقضاء مجوز',
        'level' => 'تخصص',
        'is_special' => 'کاربری ویژه',
        'plaintiffId' => 'نام شاکی',
        'complainantId' => 'نام متشاکی',
        'is_special_user' => 'کاربری ویژه',
        'categories' => 'دسته‌بندی‌ها',
        'price' => 'قیمت',
        'type' => 'نوع',
        'reportable id',
        'reportableTitle' => 'عنوان تخلف',
        'reportableCategory' => 'دسته بندی تخلف',
        'severityViolation' => 'شدت تخلف',
        'arbitrator_description' => 'شرح داوری',
        'is_job' => 'گروه شغلی',
        'job_title' => 'عنوان شغلی',
        'is_suspended' => 'مسدود شدن',
        'suspension_level' => 'سطح تعلیق',
        ...
        'suggested_date' => 'تاریخ بازدید',
        'request' => 'درخواست',
        'thumbnail' => 'تصویر شاخص',
        'thumbnail_id' => 'تصویر شاخص',
        'property_code' => 'کد ملک',
        'category_ids' => 'دسته بندی',
        'property_owner_id' => 'مالک ملک',
        'message' => 'ییغام',
        'mail_message'=> 'متن پیام ایمیل',
        'sms_message'=> ' متن پیام اس ام اس',
        'property_ids'=> 'ایدی املاک',
        'bed' => 'اتاق خواب',
    ],
